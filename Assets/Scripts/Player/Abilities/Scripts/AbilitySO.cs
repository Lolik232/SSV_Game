...
public class AbilitySO : ScriptableObject
{
    ...
    protected virtual void OnEnable()
    {
        ...
        updateActions.Clear();
        useConditions = new List<Func<bool>> { () => IsAble && !isActive && amountOfUsagesLeft > 0 && Time.time > endTime + cooldown };
        terminateConditions = new List<Func<bool>> { () => !isActive || duration != 0 && Time.time > startTime + duration };
    }
    ...
    public void SetZeroAmountOfUsages() => amountOfUsagesLeft = 0;
